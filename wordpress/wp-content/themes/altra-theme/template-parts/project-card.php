    ...
    <a href="<?php the_permalink(); ?>" class="project-link">
        ...
        <div class="project-info">
            <p class="project-caption">
                <strong class="project-title"><?php echo $client ? esc_html($client) : get_the_title(); ?></strong><?php if ($photographer) : ?><span class="project-sep"> — </span><span class="project-photographer"><?php echo esc_html($photographer); ?></span><?php endif; ?>
            </p>
        </div>
    </a>
</article>
