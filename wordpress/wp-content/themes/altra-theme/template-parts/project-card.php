...
<article class="project-card <?php echo esc_attr($orientation_class); ?>"
         ...
         data-focal-x="<?php echo isset($visual_settings['focalPoint']['x']) ? esc_attr(max(0, min(1, floatval($visual_settings['focalPoint']['x'])))) : '0.5'; ?>"
         data-focal-y="<?php echo isset($visual_settings['focalPoint']['y']) ? esc_attr(max(0, min(1, floatval($visual_settings['focalPoint']['y'])))) : '0.5'; ?>"
